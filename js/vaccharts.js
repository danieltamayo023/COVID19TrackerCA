        ...
        chartdata: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    pointBorderWidth: 1,
                    pointBorderColor: "rgba(255,255,255,0.8)",
                    pointBackgroundColor: "#363A3F",
                    pointHoverBackgroundColor: "#363A3F",
                    backgroundColor: "rgba(0, 0, 0, 0)",
                    borderColor: "#363A3F",
                    data: allData["30-39"],
                    hidden: false
                ...
                },
                {
                    ...
                    pointBorderWidth: 1,
                    pointBorderColor: "rgba(255,255,255,0.8)",
                    pointBackgroundColor: "#373A3F",
                    pointHoverBackgroundColor: "#373A3F",
                    backgroundColor: "rgba(0, 0, 0, 0)",
                    borderColor: "#373A3F",
                    data: allData["70-79"],
                    hidden: false
                },
                {
                    ...
                    pointBorderWidth: 1,
                    pointBorderColor: "rgba(255,255,255,0.8)",
                    pointBackgroundColor: "#383A3F",
                    pointHoverBackgroundColor: "#383A3F",
                    backgroundColor: "rgba(0, 0, 0, 0)",
                    borderColor: "#383A3F",
                    data: allData["80+"],
                    hidden: false
